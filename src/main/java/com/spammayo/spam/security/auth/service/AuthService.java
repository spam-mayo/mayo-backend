package com.spammayo.spam.security.auth.service;
...
public class AuthService {
    ...
    private String setPasswordContext(String authCode) {
        ...
        context.setVariable("link", "http://ec2-3-38-166-165.ap-northeast-2.compute.amazonaws.com:8080/auth/password/" + authCode);
