...
public class StudyController {
    ...
    public ResponseEntity getStudies(@RequestParam @Positive int page,
        ...
        Page<Study> pages = studyService.findStudies(page - 1, size, field, stack, sort, area);
    ...
    public ResponseEntity getUserStudy(@RequestParam(required = false) String tab,
        ...
        return new ResponseEntity<>(mapper.studiesToListResponseDto(userStudy), HttpStatus.OK);
    }
